  ...
  return (
    <nav className='w-full fixed z-40'>
        <div className={`${showBackground ? 'bg-zinc-900 bg-opacity-90' : ''} px-4 md:px-16 py-6 flex flex-row items-center transition duration-500`}>
            ...
            <div className='lg:hidden flex flex-row items-center gap-2 ml-8 cursor-pointer relative' onClick={toggleMobielMenu}>
            ...
            <div className='flex flex-row ml-auto gap-7 items-center'>
                ...
                <div className='flex flex-row items-center gap-2 cursor-pointer relative' onClick={toggleAccountMenu}>
                    <div className='w-6 h-6 lg:w-10 lg:h-10 rounded-md overflow-hidden'>
                        <img src="/images/default-blue.png" alt="" className="" />
                    </div>
                    <BsChevronDown className={`${showAccountMenu ? 'rotate-180' : 'rotate-0'} text-white transition`} />
